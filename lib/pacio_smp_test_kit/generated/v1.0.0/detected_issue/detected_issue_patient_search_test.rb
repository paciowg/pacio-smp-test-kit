...
module PacioSMPTestKit
  module PacioSMPV100
    class DetectedIssuePatientSearchTest < Inferno::Test
      include PacioSMPTestKit::SearchTest

      title 'Server returns valid results for DetectedIssue search by patient'
      description %(
A server SHALL support searching by
patient on the DetectedIssue resource. This test
...
[PACIO SMP Server CapabilityStatement](/CapabilityStatement-smp-server.html)
      ...
      id :smp_v100_detected_issue_patient_search_test
      optional
